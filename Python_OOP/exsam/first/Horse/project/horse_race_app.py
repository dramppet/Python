...
class HorseRaceApp:
    ...
    def add_jockey(self, jockey_name: str, age: int):
        ...
        if jockey_name in [j.name for j in self.jockeys]:
            raise Exception("Jockey {jockey_name} has been already added!")
    ...
    def add_jockey_to_horse_race(self, race_type: str, jockey_name: str):
        ...
        try:
            horse_rase = next(filter( lambda  hr: hr.rase_type == race_type, self.horse_races))
        except StopIteration:
        ...
        if jockey in horse_rase.jockeys:
            return f"Jockey {jockey_name} has been already added to the {race_type} race."

        horse_rase.jockeys.append(jockey)
    ...
    def start_horse_race(self, race_type: str):
        ...
        if len(self.horse_races.jockeys) < 2:
